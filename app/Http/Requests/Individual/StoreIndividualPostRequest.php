...
class StoreIndividualPostRequest extends Request
{
    public function authorize(UserRepository $user)
    {
        return $user->currentUserHasAccess('admin.organisation.individual.store');
    }
    ...
    public function rules()
    {
        ...
        [
            ...
            'individual_email'  => 'email|max:254|unique:individuals,email',
